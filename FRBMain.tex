    ...
    \begin{center}
      {
        ...
        \zhongsong{第三十四届“冯如杯”竞赛主赛道项目论文Latex模板} %黑体这样调用，其余字体同理
      } 
...
%********************正文页眉部分********************
%\lhead{} 
\chead{\xiaowu 北京航空航天大学第三十四届“冯如杯”竞赛主赛道参赛作品} %设置居中页眉
%********************正文页眉部分********************
...
\setParDis %设置段间距为 0
\begin{spacing}{1.5}
  第三十四届“冯如杯”主赛道论文一律由在计算机上输入、排版、定稿后转成PDF格式，
...
\begin{table}[H]
\small
\caption{样本描述性统计结果（N=34315）}
\centering
\begin{tabular}{cccccc}
\hline  
\textbf{变量名} & \textbf{含义} & \textbf{不具有数量} & \textbf{不具有比例} & \textbf{具有数量} & \textbf{具有比例} \\ 
\hline  
方法1 & 互动视频  & 数据  & 数据  & 数据 & 1\\
方法2 & 合作共创  & 数据  & 数据  & 数据 & 1\\
方法2 & 生活性    & 数据  & 数据  & 数据 & 1\\
